...
class WaveLayer: CAShapeLayer {
    ...
    var wavePathPre: UIBezierPath {
        ...
        arcPath.moveToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x: 49, y: 99))
        arcPath.addLineToPoint(CGPoint(x: 51, y: 99))
        arcPath.addLineToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.closePath()
        return arcPath
    }
    ...
    var wavePathStarting: UIBezierPath {
        let arcPath = UIBezierPath()
        arcPath.moveToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x: 30, y: 80))
        arcPath.addCurveToPoint(CGPoint(x: 70.0, y: 80.0), controlPoint1: CGPoint(x: 30.0, y: 70.0), controlPoint2: CGPoint(x: 40.0, y: 90.0))
        arcPath.addLineToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.closePath()
        return arcPath
    }
    ...
    var wavePathLow: UIBezierPath {
        let arcPath = UIBezierPath()
        arcPath.moveToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x:10, y: 60.0))
        arcPath.addCurveToPoint(CGPoint(x: 90.0, y: 60.0), controlPoint1: CGPoint(x: 30.0, y: 65.0), controlPoint2: CGPoint(x: 40.0, y: 50.0))
        arcPath.addLineToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.closePath()
        return arcPath
    }
    ...
    var wavePathMid: UIBezierPath {
        let arcPath = UIBezierPath()
        arcPath.moveToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x: -10.0, y: 40.0))
        arcPath.addCurveToPoint(CGPoint(x: 110.0, y: 40.0), controlPoint1: CGPoint(x: 30.0, y: 30.0), controlPoint2: CGPoint(x: 40.0, y: 50.0))
        arcPath.addLineToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.closePath()
        return arcPath
    }
    ...
    var wavePathHigh: UIBezierPath {
        let arcPath = UIBezierPath()
        arcPath.moveToPoint(CGPoint(x: 50, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x: -30.0, y: 20.0))
        arcPath.addCurveToPoint(CGPoint(x: 130.0, y: 20.0), controlPoint1: CGPoint(x: 30.0, y: 25.0), controlPoint2: CGPoint(x: 40.0, y: 10.0))
        arcPath.addLineToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.closePath()
        return arcPath
    }
    ...
    var wavePathComplete: UIBezierPath {
        let arcPath = UIBezierPath()
        arcPath.moveToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x: -50.0, y: -5.0))
        arcPath.addLineToPoint(CGPoint(x: 150.0, y: -5.0))
        arcPath.addLineToPoint(CGPoint(x: 50.0, y: 100.0))
        arcPath.closePath()
        return arcPath
    }
